...
const SUB_PATH = process.env.SUB_PATH || 'dcdy';       // 订阅路径
const PORT = process.env.SERVER_PORT || process.env.PORT || 3322;        // http服务订阅端口
...
const ARGO_PORT = process.env.ARGO_PORT || 3069;            // 固定隧道端口,使用token需在cloudflare后台设置和这里一致
...
const NAME = process.env.NAME || 'dc';                        // 节点名称
